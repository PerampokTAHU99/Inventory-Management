...
<head>
    ...
    <title>Inventory MTP - Barang Masuk</title>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                ...
                                <!-- button export -->
                                <a href="exportInItem.php" class="btn btn-info text-white" target="
                                -blank">Export Data</a>
                            </div>
                            <!-- The Modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="function.php">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="inputItem" class="btn btn-primary">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $inItemId; ?>">
                                                    Edit
                                                </button>
                                                <input type="hidden" name="itemToDeleted" value="<?= $itemId; ?>">
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?= $inItemId; ?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- The Edit Modal -->
                                        <div class="modal fade" id="edit<?= $inItemId; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="function.php">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="inItemId" value="<?= $inItemId; ?>">
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" name="updateIncomingItem" class="btn btn-primary">Submit</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <!-- The Delete Modal -->
                                        <div class="modal fade" id="delete<?= $inItemId; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="function.php">
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" name="deleteIncomingItem" class="btn btn-danger">Delete</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
